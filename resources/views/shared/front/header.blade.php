      ...
      <div class="container-fluid">
        <div class="grid">
          <div class=" navbar-collapse wrapper-nav" id="navbarTogglerDemo01">
                          ...
                          <div class="header-auth-subLogin">
                            <div class="header-auth-subLogin__list">
                              <div class="header-auth-subLogin-item">
                                ...
                                <a class="header-auth-subLogin-link" href="{{route('front.account')}}" onclick="">Tài
                                  khoản của bạn</a>
                              </div>
                              <div class="header-auth-subLogin-item">
                                <span class="material-symbols-outlined header-auth-subLogin-icon">
                              ...
                              <div class="header-auth-subLogin-item">
                                ...
                                <a class="header-auth-subLogin-link" href="{{route('front.address')}}" onclick="">Địa chỉ
                                  giao hàng</a>
                              </div>
                              <div class="header-auth-subLogin-item">
                                <span class="material-symbols-outlined header-auth-subLogin-icon">
            ...
            <a class="navbar-brand logo-header" href="{{route('homepage')}}">
            ...
            <form class="container-search" role="search"  method="get" action="{{route('products.search')}}">
