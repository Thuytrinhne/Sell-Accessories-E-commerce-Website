            ...
            <div class="signup_body-form" >
                <div class="signup_body-form-container">
                    ...
                    <div class="signup_body-input verified">
                        ...
                        <input type="text" placeholder="Nhập mã xác thực 6 số" ><button>Lấy mã</button><br>
                        
                    </div>

                    <div class="signup_body-input">
                        <!-- <label for="" style="margin-bottom: 6px;">Nhập mật khẩu</label>  <br> -->
                        <input type="text" placeholder="Nhập mật khẩu từ 6-32 kí tự"><br>
                    </div>
                    ...
                    <div class="signup_button">
                        <button class="signup_btn" onclick="sigUpOnclick()">Đăng ký</button><br>
                    </div>
